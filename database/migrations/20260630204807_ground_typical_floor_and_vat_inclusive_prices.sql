alter table public.projects add column if not exists price_includes_vat boolean not null default true;
alter table public.project_prices add column if not exists price_includes_vat boolean not null default true;
